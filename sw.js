const CACHE='clearchoice-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./assets/icon.svg','./lib/decision-engine.js','./lib/storage.js','./lib/export.js'];
